...
```
cd existing_repo
git remote add origin https://gitlab.thelbc.io/kruze.murdock/kruze-new-lab.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.thelbc.io/kruze.murdock/kruze-new-lab/-/settings/integrations)
